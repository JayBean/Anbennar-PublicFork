...
NAI = {
	...
	PEACE_WAR_EXHAUSTION_FACTOR = 2.0, -- AI willingness to peace based on war exhaustion #Anbennar, default 1.0
	...
	PEACE_WAR_DIRECTION_FACTOR = 1, -- AI willingness to peace based on who's making gains in the war #Anbennar, Default 0.5
	...
	BORDER_DISTANCE_SCORE_IMPACT = 10,							-- Border <-> province distance impact on province evaluation #Anbennar, Default 3.0
	IMPORANT_PROVINCE_THRESHOLD = 0.01,							-- AI will try to defend provinces under threat worth more than this percentage of total development #Anbennar, Default 0.05
