...
NCountry = {
	...
	PS_BOOST_MILITARIZATION = 150,
	PS_ESTABLISH_SIBERIAN_FRONTIER = 100,
...
NEconomy = {
	...
	COLONIAL_MAINTENANCE_FACTOR = 4.0,				-- _EDEF_COLONIAL_MAINTENANCE_FACTOR_	anbennar changed this from 8 to 4
