...
NAI = {
	...
	MAX_CAV_PERCENTAGE = 70, -- For modding, actual ratio is dynamically computed but will be no higher than this.
...
NReligion = {
	...
	REFORM_DESIRE_PER_YEAR = 0.005,								-- Increase of reform descire for each year.	#Anbennar - increased this from 0.005 to 0.1
